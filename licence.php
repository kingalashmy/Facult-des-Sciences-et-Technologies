    ...
    <div class="main-container">
        ...
        <div class="partie-right" >
                ...
                <!-- 
                 ...
                 -->
                 <h1 style="text-align: center; margin-top: 100px ; margin-bottom: 80px ; ">FORMATION LICENCE </h1>
           <section class="Formation">
      
        <div class="licence" style="margin-top: -60px;">
         
             <div class="licence-col">
                <h3><a href="AD.php">Analytique des données</a></h3>
               
             
            </div>
      
            <div class="licence-col">
                <h3> <a href="IDAI.php">Ingénierie de Développement d’Applications Informatiques </a> </h3>
               
                
                
            </div>
            <div class="licence-col">
                <h3><a href="#">Ingénierie Statistique</a></h3>
            ...
            <div class="licence-col">
                <h3><a href="#">Mathématiques et Applications</a> </h3>                       
            </div>
            <div class="licence-col">
                <h3><a href="#">Ingénierie Statistique</a> </h3>  
            ...
            <div class="licence-col">
                <h3><a href="#">Énergies Renouvelables (EnR)</a> </h3>   

            </div>

            <div class="licence-col">
                <h3><a href="#">Géosciences Appliquées</a> </h3>   

            </div>

            <div class="licence-col">
                <h3><a href="#">Génie Informatique</a> </h3>   

            </div>

            <div class="licence-col">
                <h3><a href="#">Génie Industriel</a> </h3>   
            ...
            <div class="licence-col">
                <h3><a href="#">Génie des Procédés</a> </h3>   

            </div>
            
            <div class="licence-col">
                <h3><a href="#">Génie civil</a> </h3>   
