	...
	<div class="main" style="height: 375px;" >  	
			...
			<div class="login-chef-depart">
				<form method="post" action="">
					<label for="chk" aria-hidden="true" style="color: #fffefe; font-size :20px; text-align: center ; " >Login Chef Departement</label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM chefs_departemet WHERE email_chef = '$Email' AND password = '$Pass'";
